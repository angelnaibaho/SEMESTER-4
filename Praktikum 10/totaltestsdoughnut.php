...
while($row = mysqli_fetch_array($covidcase)){
    ...
    $query = mysqli_query($koneksi,"select totaltests from tb_covidcase where id_case='".$row['id_case']."'");
...
<head>
	<title>Doughnut Chart Total Tests Covid Case</title>
	<script type="text/javascript" src="Chart.js"></script>
</head>

<body>
	<center><h1>Grafik Doughnut Total Tests</h1>
	<br>
